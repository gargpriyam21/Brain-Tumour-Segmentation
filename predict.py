...
class Prediction(object):
    ...
    def predict_volume(self, filepath_image,show):
        ...
        #read the volume
        flair = glob( filepath_image + '/*Flair*/*.mha')
        t2 = glob( filepath_image + '/*_T2*/*.mha')
        gt = glob( filepath_image + '/*more*/*.mha')
        t1s = glob( filepath_image + '/**/*T1*.mha')
        t1c = glob( filepath_image + '/*T1*/*_n.mha')
    ...
    def evaluate_segmented_volume(self, filepath_image,save,show,save_path):
        ...
        if save:
            ...
            sitk.WriteImage ( tmp,'predictions/{}.mha'.format(save_path) )

            tmp1=sitk.GetImageFromArray(gt)
            sitk.WriteImage ( tmp1,'predictions/gt/{}.mha'.format(save_path) )
...
if __name__ == "__main__":
    ...
    #set arguments
    model_to_load="brain_segmentation/ResUnet.03_1.449.hdf5" 
    ...
    brain_seg_pred.predict_multiple_volumes(test_path[210:211],save=True,show=True)
